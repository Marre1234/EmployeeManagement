...
public class EmployeeStats {
    ...
    public double getAverageSalary() {
        ...
        return totSal / employeeList.size();
    }
    ...
    public void printGenderRatio() {
        ...
        if (employeeList.size() != 0) {
            ...
            System.out.println("Female: " + (females / allEmployees) * 100 + "%");
            System.out.println("Male: " + (males / allEmployees) * 100 + "%");
            System.out.println("Unknown: " + (unknown / allEmployees) * 100 + "%");
    ...
    public void printGenderRatioWithinProfessions() {
        ...
        System.out.println("Females: " + (shareHoldersFemales / shareHolderList.size()) * 100 + "%");
        System.out.println("Unknown: " + (shareHoldersUnknowns / shareHolderList.size()) * 100 + "%");

        System.out.println("\nFull time employee gender ratio:");
        System.out.println("Males: " + (fullTimeMales / fullTimeList.size()) * 100 + "%");
        System.out.println("Females: " + (fullTimeFemales / fullTimeList.size()) * 100 + "%");
        System.out.println("Unknowns: " + (fullTimeUnknowns / fullTimeList.size()) * 100 + "%");

        System.out.println("\nContractor employee gender ratio:");
        System.out.println("Males: " + (contractorsMales / contractorList.size()) * 100 + "%");
        System.out.println("Females: " + (contractorsFemales / contractorList.size()) * 100 + "%");
        System.out.println("Unknowns: " + (contractorsUnknowns / contractorList.size()) * 100 + "%");
    }
}
